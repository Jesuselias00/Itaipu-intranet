...
CREATE TABLE IF NOT EXISTS funcionarios (
    ...
    id_cargo INT, -- Coluna para a chave estrangeira
...
CREATE TABLE IF NOT EXISTS usuarios (
    ...
    senha_hash VARCHAR(255) NOT NULL, -- Renomeado de password_hash para consistência
    ...
    -- CORREÇÃO APLICADA AQUI: Referencia 'funcionarios(id)'
...
CREATE TABLE IF NOT EXISTS solicitacoes_cracha (
    ...
    status_solicitacao VARCHAR(50) DEFAULT 'Pendente', -- Ex: Pendente, Aprovado, Rejeitado, Impresso
    observacoes TEXT,
